...
// Steps with <b> tags, subtitles, and images
const steps = [
  { 
...
export default function OnboardingScreen() {
  ...
  const panResponder = useRef(
    PanResponder.create({
        ...
        // Only allow swipe if not at start/end
  ...
  return (
    <View
        ...
        {...(index < steps.length - 1 ? panResponder.panHandlers : {})} // disable swipe on last step
    >
      {/* Animated Content */}
      <Animated.View style={[styles.textSection, { transform: [{ translateX: slideAnim }] }]}>
        ...
        {/* Subtitle */}
        <Text style={[styles.description, { fontSize: rf(16), lineHeight: rf(20), paddingRight: rf(40), marginTop: rf(15) }]}>
      ...
      <View style={[styles.progressContainer, { justifyContent: 'center', marginTop: rf(0) }]}>
        {steps.map((_, i) => (
          <View
            ...
            style={[
              styles.progressBar,
              { width: rf(15), backgroundColor: i <= index ? '#8d1cdd' : '#ccc' },
            ]}
          />
        ))}
      </View>
        ...
        <TouchableOpacity
            ...
            <View
                ...
                index === steps.length - 1
                    ? { paddingHorizontal: rf(25), height: rf(45), borderRadius: rf(25) } // wider for Continue
                    : { width: rf(45), height: rf(45), borderRadius: rf(100) } // circle for arrow
                ]}
            >
                {index === steps.length - 1 ? (
                ...
                <Svg width={rf(15)} height={rf(15)} viewBox="0 0 24 24">
                    <Path d="M23.987 12a2.411 2.411 0 0 0 -0.814 -1.8L11.994 0.361a1.44 1.44 0 0 0 -1.9 2.162l8.637 7.6a0.25 0.25 0 0 1 -0.165 0.437H1.452a1.44 1.44 0 0 0 0 2.88h17.111a0.251 0.251 0 0 1 0.165 0.438l-8.637 7.6a1.44 1.44 0 1 0 1.9 2.161L23.172 13.8a2.409 2.409 0 0 0 0.815 -1.8Z" fill="#fff" />
                </Svg>
                )}
            </View>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  description: {
    color: '#8d8d8d',
    fontWeight: '400',
    fontFamily: 'Cabin-VariableFont_wdth,wght',
  },
  progressContainer: {
    flexDirection: 'row',
    gap: 10,
