...
export default function StatsScreen({ navigation }: any) {
  ...
  const dynamicStyles = useMemo(() => ({
    ...
    summaryRow: { borderBottomColor: theme.colors.borderLight },
    ...
    <PageLayout title="Stats" navigation={navigation}>
      ...
      >
        ...
        <View style={[styles.summaryRow, dynamicStyles.summaryRow]}>
          ...
          <View style={styles.summaryItem}>
            <Text style={[styles.summaryLabel, dynamicStyles.totalsLabel]}>Exp.</Text>
            <Text style={[styles.summaryValue, { color: theme.colors.error }]}>
              {totals.expense.toFixed(2)}
            </Text>
          </View>
          <View style={styles.summaryItem}>
            <Text style={[styles.summaryLabel, dynamicStyles.totalsLabel]}>Total</Text>
            <Text
              style={[
                styles.summaryValue,
